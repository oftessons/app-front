...
export const temasESubtemas: Record<Tema, Subtema[]> = {
  [Tema.AAO_ADAPTED]: [
    ...
    Subtema.OPHTHALMIC_PATHOLOGY_AND_INTRAOCULAR_TUMORS,
    Subtema.NEURO_OPHTHALMOLOGY,
    Subtema.PEDIATRIC_OPHTHALMOLOGY_AND_STRABISMUS,
    Subtema.OCULOFACIAL_PLASTIC_AND_ORBITAL_SURGERY,
    Subtema.EXTERNAL_DISEASE_AND_CORNEA,
    Subtema.UVEITIS_AND_OCULAR_INFLAMMATION,
    Subtema.GLAUCOMA,
    Subtema.LENS_AND_CATARACT,
    Subtema.RETINA_AND_VITREOUS,
    Subtema.REFRACTIVE_SURGERY
  ...
  [Tema.ICO_PART_1]: [
    Subtema.ANATOMY,
    Subtema.CELL_BIOLOGY,
    Subtema.EPIDEMIOLOGY_AND_BIOSTATISTICS,
    Subtema.GENETICS,
    Subtema.IMMUNOLOGY,
    Subtema.INSTRUMENTS_AND_INVESTIGATIONS,
    Subtema.MICROBIOLOGY,
    Subtema.OPTICS,
    Subtema.PATHOLOGY,
    Subtema.PHARMACOLOGY,
    Subtema.PHYSIOLOGY,
  ],
  ...
  [Tema.SBRV]: [
    ...
    Subtema.ESTUDOS,
    Subtema.FARMACOLOGIA,
    Subtema.GENETICA,
    Subtema.IE_PNEUMATICA,
    Subtema.INFECCIOSAS,
